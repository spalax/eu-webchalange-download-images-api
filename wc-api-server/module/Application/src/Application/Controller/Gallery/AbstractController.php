...
abstract class AbstractController extends ZendAbstractController
{
    ...
    {
        /* @var $authenticationService \Application\Service\Instagram\AuthenticationService */
        ...
        $this->serviceLocator->get('di')->get('Application\Service\Instagram\AuthorizationService')->authorize();
    ...
    */
    protected function attachDefaultListeners()
    {
        ...
        $this->getEventManager()->attach(MvcEvent::EVENT_DISPATCH, function (MvcEvent $event) {
            $event->getTarget()->layout('layout/application/gallery');
        });
    }
}
